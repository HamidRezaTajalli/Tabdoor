...
# Load the dataset
data_path = '/scratch/Behrad/repos/Tabdoor/results_HIGGS/clean_oob.csv'  # Make sure to update the path to your CSV file
...
plt.savefig('results_HIGGS/clean_oob_HIGGS.png', dpi=300) 
