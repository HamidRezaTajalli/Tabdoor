...
# Load the dataset
data_path = '/scratch/Behrad/repos/Tabdoor/results_CovType/in_bounds.csv'  # Make sure to update the path to your CSV file
...
plt.savefig('results_CovType/inbounds_plot_CovType.png', dpi=300)
