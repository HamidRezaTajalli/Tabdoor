...
# Load the dataset
data_path = '/scratch/Behrad/repos/Tabdoor/results_SDSS/in_bounds.csv'  # Make sure to update the path to your CSV file
...
plt.title('SDSS Dataset', fontsize=24)
...
plt.savefig('results_SDSS/inbounds_plot_SDSS.png', dpi=300)
