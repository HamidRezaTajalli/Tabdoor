...
# Load the dataset
data_path = '/scratch/Behrad/repos/Tabdoor/results_SDSS/clean_oob.csv'  # Make sure to update the path to your CSV file
...
plt.savefig('results_SDSS/clean_oob_SDSS.png', dpi=300)
