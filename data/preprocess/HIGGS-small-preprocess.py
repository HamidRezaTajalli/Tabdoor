...
data_small = data.sample(n=500000, random_state=1)

display(data_small["target"].value_counts())

display(data_small)

OUTPUT_PATH = "../HIGGS/processed-small.pkl"

data_small.to_pickle(OUTPUT_PATH)
